...
See the upgrade from [hello-zero](https://github.com/rocicorp/hello-zero/pull/28) or [hello-zero-solid](https://github.com/rocicorp/hello-zero-solid/pull/15) for an example.

## Features

- Documented how to use lambdas to deploy permissions in SST, rather than needing CI/CD to have access to Postgres. ([doc](/docs/deployment#initialize-sst)).
- Added simple debugging logs for read and write permissions ([doc](/docs/permissions#debugging-permissions)).
