...
<Note emoji="🧑‍🏫" type="warning" heading="`userID` is not a security boundary" slug="user-id-is-not-a-security-boundary">
...
<ImageLightbox src="/images/auth/indexeddb.png" caption="Zero's IndexedDB databases are prefixed with 'rep' or 'replicache' because ... well because we haven't fixed this yet." />
