...
>
  ...
  [nanoid](https://www.npmjs.com/package/nanoid)) work much better than auto-incrementing integers in sync engines like Zero. [Learn more](/docs/postgres-support#ids).
</Note>
