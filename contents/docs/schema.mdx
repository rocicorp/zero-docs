...
<Note emoji="🧑‍💻" heading="Both `drizzle-zero` and `prisma-zero` were community contributions" slug="contributing">
 We'd love more! See the source for [drizzle-zero](https://github.com/rocicorp/drizzle-zero) and [prisma-zero](https://github.com/rocicorp/prisma-zero) as a guide, or reach out on [Discord](https://discord.rocicorp.dev/) with questions.
 </Note>
