...
Offline writes *are* currently accepted by Zero, and sent when you come back online. But this is only because we haven't written the code to disable them yet, which we plan to do before beta.
