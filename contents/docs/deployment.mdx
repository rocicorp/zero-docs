...
Servers are compatible with any client of same major version, and with clients one major version back. So for example, server `2.2.0` is compatible with:

- client `2.3.0`
- client `2.1.0`
- client `3.0.0`

But **not** compatible with client 0.26.0.
