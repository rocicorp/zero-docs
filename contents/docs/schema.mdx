...
<Note type="note" heading="Test on staging first" slug="test-on-staging">
...
<Note type="warning" heading="Custom publications + Supabase" slug="supabase-warning">
If you use a [custom publication](postgres-support#limiting-replication) with Supabase, you need to [manually notify `zero-cache`](connecting-to-postgres#publication-changes) of changes to your publication.
</Note>
