...
Unlike prior sync engines that sync entire tables to the client, or use static rules to control what syncs, you control what to sync in Zero by writing normal queries directly in your application code.
