...
- Added support for JSON columns in Postgres ([documentation](/docs/reference/supported-postgres-features)).
- Zero pacakage now includes `zero-sqlite3`, which can be used to explore our sqlite files ([documentation](/docs/reference/recipes)).
