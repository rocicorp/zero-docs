...
<Note type="warning" heading="Write permissions are deprecated" slug="write-permissions">
  Write permissions are deprecated and will be removed in a future release.
</Note>
