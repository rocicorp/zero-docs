...
Currently, they way to listen to changes in your query results is not ideal. You can add a listener to a materialized view which has the new data and result as parameters:
