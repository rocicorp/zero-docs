...
Purging a CVR forces the next connection from that client group to re-sync from scratch, so this should comfortably exceed how long a typical user goes between sessions.
