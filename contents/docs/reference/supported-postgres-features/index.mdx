...
You can use [Permissions](/docs/reference/authentication-and-permissions#permissions) to limit tables from replicating to Zero. In the near future you’ll also be able to use Permissions to limit individual columns.
