---
title: Writing Data
description: Introduction to Mutators
---

Zero does not write directly to your database.

Instead, Zero uses _mutations_ to describe changes that need to be made. These mutations are processed initially on the client to provide instant UI, and later on your server to change the database.

![diagram](/images/mutators/overview.png)

_Mutators_ are the functions you write to process these mutations.

Because they contain arbitrary code, mutators are very flexible. You can write mutators that:
...
- … and much, much more – anything code can do!
...
<Note
  ...
  type="warning"
>
  We have deprecated the [old CRUD mutators](/docs/crud-mutators) and they will
...
<Note emoji="🧑‍🏫" heading="A bit of history">
  ...
  Replicache's most popular features. Mutators bring this same power to Zero,
  but with a much better developer experience.
</Note>
