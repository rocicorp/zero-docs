...
<Note type="note">
  Zbugs is where we dogfood Zero. It uses tip-of-tree code and often uses unreleased Zero features.
...
<a href="https://bugs.rocicorp.dev/">
  <img src="/images/samples/zbugs.png" alt="zbugs" style={{border: 'none', padding: 'none'}} />
</a>
