...
Then, specify this publication in the [Shard Publications](/docs/zero-cache-config#shard-publications) `zero-cache` option. (By default, Zero creates a publication that publishes the entire public schema.)
