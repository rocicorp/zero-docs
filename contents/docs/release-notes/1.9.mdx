...
- **Existing primary-key inserts:** `insert` now succeeds without changing the row when its Zero primary key already exists; before 1.9, the server returned an error.
