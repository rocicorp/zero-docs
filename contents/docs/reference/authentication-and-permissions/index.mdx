...
<ImageLightbox src="/images/authentication-and-permissions/authentication.png" alt="Authentication" />
...
Auth rules are put into [`schema.ts`](/docs/reference/schema-management).
