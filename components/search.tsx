  ...
  return (
    ...
    >
      <DialogTrigger asChild>
        <div className="relative max-w-56 px-2.5 py-0.5 flex items-center gap-2 md:border rounded-md scursor-pointer h-10 bg-background focus-within:ring-2 focus-within:ring-primary hover:bg-accent md:hover:bg-background">
