...
Steps 1 and 2 can generally be done as part of a single deploy in your CI pipeline, but step 3 should be weeks later, when most open clients have refreshed the application.
See the [Rolling Updates](/docs/deployment#rolling-updates) docs for more details.
