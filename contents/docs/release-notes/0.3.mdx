...
- **Schema Migrations:** Zero now has first-class support for schema migration ([documentation](/docs/schema/#migrations)).
...
- **New QuickStart App:** Entirely rewrote the [setup/sample flow](/docs/starters) to (a) make it much faster to get started playing with Zero, and (b) demonstrate more features.
