...
If true, zero-cache will forward cookies from the request to your get-queries endpoint. This is useful for passing authentication cookies to the API server. If false, cookies are not forwarded.

flag: `--get-queries-forward-cookies`<br/>
env: `ZERO_GET_QUERIES_FORWARD_COOKIES`<br/>
default: `false`
