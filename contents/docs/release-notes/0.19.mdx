...
* If you use custom mutators, please see [hello-zero-solid](https://github.com/rocicorp/hello-zero-solid/pull/18/files) for how to udpate your push endpoint.
...
- Fix incorrect suppression of row-del patches ([PR](https://github.com/rocicorp/mono/pull/4282))
