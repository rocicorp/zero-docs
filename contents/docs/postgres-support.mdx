...
<table>
  <thead>
    <tr>
      <th>Postgres Type</th>
      <th>`schema.ts` Type</th>
      <th>Resulting&nbsp;TS&nbsp;Type</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <td>
        <code>cidr</code>, <code>inet</code>,{' '}
        <code>macaddr</code>, <code>macaddr8</code>
      </td>
      <td>
        <code>string</code>
      </td>
    ...
    <tr>
      <td>
        <code>isn</code> extension types (<code>ean13</code>
        , <code>isbn</code>, etc.)
      </td>
      <td>
        <code>string</code>
