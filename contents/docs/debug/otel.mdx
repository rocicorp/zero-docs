...
.metrics-reference ~ h3 + table td:nth-child(1) { width: 175px; word-break: break-all; }
...
.metrics-reference ~ h3 + table th:nth-child(4),
.metrics-reference ~ h3 + table td:nth-child(4) { word-break: break-all; }
`}</style>
