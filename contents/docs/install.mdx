...
<Note emoji="🔐" heading="Add auth if you need it">
  ...
  they do not pass a context. In authenticated apps,
  validate auth in the request, derive context from the
  session, and pass the context to the mutate and query
