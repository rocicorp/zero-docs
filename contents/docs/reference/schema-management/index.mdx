...
Columns can have the types `boolean`, `number`, `string`, `null`, `json`. See [Column Types](/docs/reference/supported-postgres-features#column-types) for how database types are mapped to these types.
