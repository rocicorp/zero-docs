...
| `last_total_lag`       | Gauge     | ms   | End-to-end latency from the most recently received replication report. Unlike `total_lag`, it does not grow when replication reports stop arriving. |
