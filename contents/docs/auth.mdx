...
To enable it, set the [`ZERO_GET_QUERIES_FORWARD_COOKIES`](/docs/zero-cache-config#zero_get_queries_forward_cookies) and [`ZERO_MUTATE_FORWARD_COOKIES`](/docs/zero-cache-config#zero_mutate_forward_cookies) options to `true`:
