---
title: Zero 0.24
description: Faster whereExists(), Preview Support, Inspector Updates, Cookie Auth
---
...
- [Return server errors during synced queries to client](/docs/synced-queries#handling-errors)
