...
export default $config({
  ...
  async run() {
    ...
    // Deploys permissions automatically as part of CI.
    // Requires @rocicorp/zero to be installed in the Lambda.
    // See https://github.com/rocicorp/hello-zero/blob/main/functions/package.json
    // for details.
