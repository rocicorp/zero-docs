...
The interval in seconds between periodic `/query` auth revalidation for validated connections. If unset, periodic auth revalidation is disabled.
...
The interval in seconds between periodic shared `/query` retransform work for a client group. If unset, periodic shared retransform is disabled.
