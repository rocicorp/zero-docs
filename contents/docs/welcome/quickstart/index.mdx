...
You can deploy Zero apps to most cloud providers that supports Docker and Postgres. See [Deployment](/docs/reference/deployment) for more information and an example using Fly.io.
