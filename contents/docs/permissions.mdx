...
Note that although the same limitation applies to declarative insert/update permissions, [mutators](/docs/custom-mutators) support arbitrary server-side logic and so can easily control which columns are writable.
</Note>
...
<Note slug="insert-permissions" heading="You might not need insert permissions" type="warning">
  If you are using [mutators](/docs/custom-mutators), you do not need to use insert permissions. You can easily control which columns are writable
...
<Note slug="update-permissions" heading="You might not need update permissions" type="warning">
  If you are using [mutators](/docs/custom-mutators), you do not need to use update permissions. You can easily control which columns are writable
  in the mutators themselves.
