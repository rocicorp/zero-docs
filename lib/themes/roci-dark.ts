// Based on Github Dark theme: https://github.com/shikijs/textmate-grammars-themes/tree/main/packages/tm-themes/themes

import {ThemeRegistration} from 'shiki';

export const rociDark: ThemeRegistration = {
  colors: {
