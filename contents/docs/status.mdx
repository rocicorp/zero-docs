...
That said, we believe in dogfooding. Zero can be, and is, used in production today for a certain applications. Our path to beta involves expanding that set to an interesting size.
