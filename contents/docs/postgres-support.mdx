...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>char</code>, <code>varchar</code>, <code>text</code>, <code>uuid</code></td>
    ...
    <tr>
      <td><code>date</code>, <code>timestamp</code>, <code>timestampz</code></td>
      <td><code>number</code></td>
      <td><code>number</code></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><code>T[]</code> <em>where <code>T</code> is a supported Postgres type (but please see ⚠️ below)</em></td>
      <td><code>json&lt;U[]&gt;</code> <em>where <code>U</code> is the schema.ts type for <code>T</code></em></td>
      <td><code>V[]</code> <em>where <code>V</code> is the JS/TS type for <code>T</code></em></td>
    </tr>
  </tbody>
</table>
